                    ...
                    <td>
                        ...
                        <?php } elseif (!empty($cita['monto'])) { ?>
                            <button class="btn-presupuesto" data-idform="<?php echo $cita['id_form']; ?>" 
                                ...
                                <?php echo ($cita['num_presupuestos'] > 1) ? 'Ver Nuevo Presupuesto' : 'Ver Presupuesto'; ?>
                            </button>
                        <?php } else { ?>
...
<div id="modalPresupuesto" class="modal-detalles">
    <div class="modal-contenido-detalles">
        ...
        <div id="presupuestoAcciones">
            <button id="btnAceptarPresupuesto" class="btn">Aceptar</button>
...
document.querySelectorAll('.btn-presupuesto').forEach(button => {
    button.onclick = function() {
        ...
        document.getElementById('presupuestoEstado').textContent = estado;
        ...
        if (estado === 'pendiente') {
            document.getElementById('presupuestoAcciones').style.display = 'block';
            document.getElementById('btnAceptarPresupuesto').onclick = function() {
                gestionarPresupuesto(idForm, 'aceptado');
            };
            document.getElementById('btnRechazarPresupuesto').onclick = function() {
                gestionarPresupuesto(idForm, 'rechazado');
            };
        } else {
            document.getElementById('presupuestoAcciones').style.display = 'none';
        }
