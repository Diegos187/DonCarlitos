...
<div class="details">
    <div class="recentOrders">
        ...
        <table class="table">
                ...
                <tr>
                    ...
                    <?php if ($row['estado'] === 'cancelado') { ?>
                        ...
                        <?php } elseif (!empty($row['monto']) && $row['estado_presupuesto'] == 'pendiente') { ?>
                            <!-- Mostrar detalles del presupuesto pendiente -->
            ...
            <?php if ($row['estado'] === 'cancelado' || $row['estado'] === 'finalizado') { ?>
                <p>No disponible</p>
    ...
    <?php } elseif ($row['estado'] === 'finalizado') { ?>
        <p>Cita finalizada</p>
    <?php } else { ?>
        <button class="btn-estado" data-idform="<?php echo $row['id_form']; ?>">
            Cambiar Estado
        </button>
    <?php } ?>
</td>
